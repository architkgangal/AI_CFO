...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Session token stored:', localStorage.getItem('ai_cfo_session_token') ? 'YES' : 'NO');
      console.log('User stored:', localStorage.getItem('ai_cfo_user') ? 'YES' : 'NO');
        ...
        <Card className="p-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl">AI CFO</span>
            </div>
          </div>
